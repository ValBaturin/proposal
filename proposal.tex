...
Despite of being similar to a distributed file system, Zookeeper has diffent purpose.
First of all, it's a service for coordinating process of distributed applications.
This design decision was taken becouse of several reasons. Using file system like
...
currently needed efforts from users for managing replicated tables in Clickhouse.
