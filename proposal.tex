...
an interface to interact with it using a client such as read-eval-print loop or an API endpoint.
...
of them is inhereted from IDatabase directly or stacked on different engines with the
